...
def makeMove(board, chests, x, y):
    ...
    if smallestDistance == 0:
        ...
        if smallestDistance < 10:
            ...
            return 'Treasure detected at a distance of %s from the sonar defice.' % (smallestDistance)
        else:
            board[x][y] = 'O'
...
If a device is directly dropped on a treasure chest, you will have discovered
